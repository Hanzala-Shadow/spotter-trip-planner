...
if __name__=='__main__':
    with patch('planner.providers.fetch_route',side_effect=fixture_route), patch('planner.providers.enrich_stop_labels'), patch('planner.providers.search_places',side_effect=fixture_search):
